...
class PartyScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text('모임 탐색', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
        ...
        body: TabBarView(
          children: [
            _buildSpotPartyList(context),
            const SignalHouseListScreen(),
          ],
        ),
  ...
  Widget _buildSpotPartyList(BuildContext context) {
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        ...
        return GestureDetector(
          onTap: () {
            Navigator.push(context, MaterialPageRoute(builder: (context) => PartyDetailScreen(partyData: party)));
          },
          child: Container(
